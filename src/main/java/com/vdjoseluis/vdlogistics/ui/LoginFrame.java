...
import com.vdjoseluis.vdlogistics.firebase.data.DataUser.SessionManager;
...
public class LoginFrame extends javax.swing.JFrame {
    ...
    private void loginUser() throws FirebaseAuthException {
        ...
        if (FirebaseAuthService.loginUser(email, password)) {
            SessionManager.currentUserId = FirebaseAuth.getInstance().getUserByEmail(email).getUid();
            dispose();
